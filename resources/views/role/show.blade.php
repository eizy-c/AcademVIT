...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header h4">Ver <b>ROL</b></div>
                     ...
                     <div class="container">
                        ...
                        <h3>Required data</h3>
                         ...
                         <div class="form-group">                            
                          ...
                          <a class="btn btn-info  float-right text-white" href="{{route('role.edit',$role->id)}}">Editar</a>
                          <a class="btn btn-default float-right" href="{{route('role.index')}}">Regresar</a>
                     </div>
                    </form>
                </div>
            </div>
